...
<%@page import="Logica.ClsLgPrestamos"%>
...
<html>
    ...
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu  bg-primary badge-primary" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item badge-primary" href="#">Prestamos</a>
        ...
        <section> 
            <%
                ...
                String Id = request.getParameter("txtPrestIdEmp");
                String Nom = request.getParameter("txtPrestNom");
                if (Id != null) {
            ...
            <div class="jumbotron-fluid align-content-lg-center alert-info">
                ...
                <form id="FrmBuscPrestEmp" class="form-inline my-2 my-lg-0 col-lg-12 justify-content-center" action="Prestamos.jsp" method="post">
                    <input name="txtPrestIdEmp" id="txtPrestIdEmp" placeholder="N` de Identificación" value="<%=valor1%>" class=" form-control mr-sm-2" type="text" required readonly>
                    <input name="txtPrestNom" id="txtPrestNom" value="<%=valor2%>" placeholder="Empleado" class=" form-control mr-ms-2 col-md-5" type="text" required readonly>&nbsp;&nbsp;
                    <button id="btnCargarDialodPrestamo" class="btn btn-outline-success my-2 my-sm-0" type="button">Buscar Empleado</button> 
            ...
            <div class="col-lg-12 align-content-lg-center my-lg-5 ">
                <div class="panel panel-warning col-lg-10 container-fluid">
                    <div class="panel-heading pa col-lg-8 align-content-center">Prestamos Asignados a:<strong> <%=valor2%></strong></div>
                    <div class="panel-body col-lg-12 my-lg-3" >
                        <table id="tblBPestamos" class="table table-responsive-lg tblS col-lg-10" >
                            ...
                            <tbody class="panel-body col-lg-8">
                                <%
                                    ...
                                    ClsLgPrestamos LgPrest = new ClsLgPrestamos();
                                    ClsEmpleado vlo_Emp = new ClsEmpleado();
                                    ResultSet vlo_RS;
                                    String vlc_Sentencia = String.format("ID_EMPLEADO = '%s'", Id);
                                    vlo_RS = LgPrest.ListarRegistro(vlc_Sentencia);
                                    while (vlo_RS.next()) {
                                %>   
                                <tr>
                                    <%int Cod = vlo_RS.getInt("COD_PRESTAMO");
                                        String IdEmpl = vlo_RS.getString("ID_EMPLEADO");
                                        double Montoprestamo=vlo_RS.getDouble("MONTO_PRESTAMO");
                                        double Cuota=vlo_RS.getDouble("CUOTA_MENSUAL");
                                    ...
                                    <td><%=fecha%></td>
                                    <td>
                                        <a onclick="CargarFormPrestamo('<%=valor1%>','<%=valor2%>','<%=Cod%>','<%=Montoprestamo%>','<%=Cuota%>','<%=fecha%>')"><img src="images/editar.png"/></a>&nbsp;&nbsp;
                                        <!--  <a href="EliminarPrestamo?codP=<%=Cod%>&idEmp=<%=IdEmpl%>"><img src="images/basura.png"/></a></td> -->                         
                        ...
                        <div class="col-lg-12 align-content-lg-center my-lg-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            %>
                            <input type="button" id="btnNuevoPrest"name="btnNuevoPrest" class="btn btn-primary" onclick="CargarFormPrestamo('<%=valor1%>','<%=valor2%>','<%=-1%>','<%=""%>','<%=""%>','<%=Fecha%>')" value=" Agregar Nuevo Prestamo " />&nbsp;&nbsp;
 ...
 <!--***********************************************************************************************************************************************-->
<!-- Aquí va ir el formulario para agregar y modificar los registros de prestamos este formulario sera un dialogo oculto que se mostrara al presionar
un botón -->

<div id="DialogFormPrestamos" class="form-group col-lg-12" title="Registro de Prestamos">
    <%
        
    %>
    <form class="form-control-ms col-lg-12" action="GuardarPrestamo" method="post">
        <div class="form-row col-lg-12">
            ...
            <div id="" class="col-lg-3">
                <label for="txtCodigoPrest" hidden>Código:</label><br>
                <input type="text" hidden="" id="txtCodigoPrest" class="col-lg-12" name="txtCodigoPrest" required>
            </div>
        ...
        <div id="" class="col-lg-12">
            ...
            <input type="text" id="txtNombEmp" class="col-lg-12" name="txtNombEmp">
        </div>
        <div class="form-row col-lg-12">
        <div id="" class="col-lg-6 my-2">
            <label for="txtMontoPrest">Monto del Préstamo:</label><br>
            <input type="number" id="txtMontoPrest" name="txtMontoPrest" class="col-lg-12"required>
        </div>
        <div id="" class="col-lg-6 my-2">
            <label for="txtMensualidad">Mensualidad</label><br>
            <input type="number" id="txtMensualidad" name="txtMensualidad" class="col-lg-12"required>
        </div>
        </div>
        <br>
        <div id="" class="form-row col-lg-12 ">
            ...
            <input id="salirFormPrestamos" type="button" onclick="" value="Salir" class="btn btn-outline-info col-md-5">
        </div>
    </form>
</div>
  ...
  <!--***************************************************************************************************************** -->
    ...
    <div class="ui-widget" id="MsIncompleto" title="Mensaje De Error">
    ...
    <!-- ***************************************************************************************************************** -->
       ...
       <%
        //muestra el mensaje cuando se guarda un registro   
        
        
    if(request.getParameter("msj")!=null){
        String m= URLDecoder.decode(request.getParameter("msj"),"UTF-8");
        %>
    <div class="ui-widget" id="ErrorGPres" title="Mensaje">
        <div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
            <p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
...
<!--***********************************************************************************************************************************************-->
        ...
        <div  id="DialodPrestamo" title="Buscar Empleados">
            ...
            <table id="tblEmpleados" class="table table-responsive tblC  col-md-12" ><!--Inicio de la tabla empleados -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="#" onclick="seleccionarRegistroEmpPrest('<%=cod%>', '<%=Nombre%>')" class="" title="Seleccionar"><img src="images/iconfinder_Select_46755.png" /></a></td>  
                    </tr> 
                    <%}%>
                </tbody>
            </table> 
